...
`;
    ...
    async loadUserVouchers() {
        ...
        voucherList.innerHTML = 'Memuat voucher...';
    ...
    " onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">
        ...
        <label for="voucher_${idx}" style="cursor: pointer; font-size: 11px;">
            ...
            <span style="color: #ccc;">Batas Waktu: ${new Date(v.expiredAt).toLocaleDateString()}</span>
        </label>
    </div>
`).join('');
            ...
            voucherList.innerHTML = '<span style="color:#e53935;">Gagal memuat voucher!</span>';
        }
    }
    ...
    calculatePrice(currentSettings) {
        ...
        if (currentSettings.enableBook) {
            ...
            if (totalPages > 10) {
                ...
                items.push({
                    name: `Halaman ekstra (${extraPages} halaman)`,
    ...
    prepareCompleteSettings(settingsToUse) {
        ...
        const completeSettings = {
            ...
            matrixText: settingsToUse.matrixText || 'HAPPYANNIVERSARY',
            matrixColor1: settingsToUse.matrixColor1 || '#ffb6c1',
            matrixColor2: settingsToUse.matrixColor2 || '#ffc0cb',
            sequence: settingsToUse.sequence || 'HAPPY|ANNIVERSARY|ANIS|❤',
    ...
    getCurrentSettingsFromModal() {
        ...
        try {
            ...
            const modalSettings = {
                ...
                matrixText: document.getElementById('matrixText')?.value || 'HAPPYANNIVERSARY',
                ...
                sequence: document.getElementById('sequenceText')?.value || 'HAPPY|ANNIVERSARY|ANIS|❤',
