const translations = {
    id: {
        ...
        matrix: "Pengaturan Efek Hujan Teks",
        matrixText: "Teks utama hujan:",
        matrixColor1: "Warna hujan teks 1:",
        matrixColor2: "Warna hujan teks 2:",
        sequence: "Pengaturan Teks Utama",
        sequenceText: "Konten Teks Utama:",
        sequenceColor: "Warna Teks Utama:",
        gift: "Pengaturan Animasi",
        giftImage: "Animasi (Opsional):",
        enableBook: "Tampilkan buku:",
        book: "Pengaturan Halaman Buku",
        enableHeart: "Tampilkan efek hati:",
        note: "⏳ Catatan: Masa berlaku hanya 7 hari, jadi jangan buat terlalu awal!",
        follow: "🥰 Ikuti saya untuk update website terbaru dan tercepat!",
        ...
        book: "Buku kenangan",
        extraPage: "Halaman ekstra",
        heartEffect: "Efek hati (dalam buku)",
        tipAuthor: "Tip untuk pembuat",
        voucherApplied: "✅ Voucher berhasil digunakan: {code} (-{discount}%)",
        loadingVoucher: "Memuat voucher...",
        noVoucher: "Anda tidak memiliki voucher sama sekali!",
        ...
        copySuccess: "Tautan produk disalin!",
        needLogin: "❌ Anda perlu login untuk membuat website! Tombol login ada di sudut kiri atas",
        minPay: "❌ Jumlah pembayaran minimum adalah 10.000 Rp!",
        error: "❌ Terjadi kesalahan!",
        invalidPage: "❌ Struktur halaman tidak valid! Saat ini ada {pages} halaman. Silakan tambah atau hapus 1 halaman agar struktur valid.",
        uploading: "📤 Mengunggah gambar halaman buku...",
        ...
        applyVoucherFail: "⚠️ Gagal menerapkan voucher, lanjut bayar dengan harga asli",
        cannotCreate: "Gagal membuat website",
        cannotCreateProduct: "Gagal membuat produk",
        cannotApplyVoucher: "Gagal menerapkan voucher!",
        cannotPay: "Kesalahan pemrosesan pembayaran: ",
        paymentRedirect: "🔄 Mengalihkan ke halaman pembayaran...",
        free: "GRATIS",
        thanks: "Terima kasih banyak! Jika Anda menyukai produk ini, silakan ikuti channel TikTok <b>tớ là Toán</b> agar saya lebih termotivasi membuat produk lainnya!",
        tiktokBtn: "🥰 lihat channel TikTok",
        heartQr: "❤️ Buat QR hati",
        heartQrCopy: "✅ Tautan QR hati disalin!",
        copyShare: "📋 Salin tautan",
        copied: "✅ Tersalin!",
        copyToClipboard: "📋 Tautan disalin ke clipboard!",
        copyFail: "❌ Gagal menyalin tautan!",

        //
        validCoverOnly: "✅ Valid (hanya sampul)",
        validCoverAndPairs: "✅ Valid (sampul + pasangan halaman)",
        invalidMissingPage: "❌ Tidak valid (kurang 1 halaman untuk membuat pasangan)",
        ...
        loading: "Membuat sesuatu yang spesial...",
        waitingIsHappiness: "Hal baik butuh waktu.",
        invalidPageStructure: "Struktur halaman tidak valid!",
        currentPages: "Saat ini ada {total} halaman.",
        bookStructureGuide: "Struktur buku membutuhkan:\n- Halaman 1: Sampul\n- Mulai halaman 2: Pasangan halaman (2-3, 4-5, 6-7...)",
        pleaseAddOrRemovePage: "Silakan tambah 1 halaman atau hapus 1 halaman agar struktur valid.",
        fullscreenNotSupported: "Browser Anda tidak mendukung mode layar penuh!",
        noteSequence: "Catatan: gunakan tanda | untuk memisahkan kata, jangan buat baris terlalu panjang",
        noteExpire: "⏳ <b>Catatan:</b> Masa berlaku hanya <b>30 hari</b>, jadi jangan buat terlalu awal!",
        followNote: "🥰 Silakan <a href=\"https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc\" target=\"_blank\" style=\"color:#ff0050;font-weight:bold;text-decoration:underline;\">ikuti saya</a> untuk update website terbaru dan tercepat!",
        on: "Nyala",
        off: "Mati",
        sec3: "3 detik",
        sec5: "5 detik",
        sec10: "10 detik",
        noGif: "Tidak ada",
        notVietnamWarning: 'Jika ada masalah, hubungi lewat TikTok<a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank" style="color:#ff0050;font-weight:bold;text-decoration:underline;"> @iamtritoan</a> untuk bantuan.',
        isSave: "Simpan QR permanen:",
        saveForever: "permanen",
        saveForeverPrice: "(Tambah 20.000 Rp)",
        thirtyDays: "30 hari",
        expireText: "Masa berlaku:",
        colorTheme: "Pilih warna:",
        settingsHint: "klik di sini untuk mengatur sesuai keinginan",
        pinkTheme: "Merah muda manis",
        blueTheme: "Biru laut keren",
